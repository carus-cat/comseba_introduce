const moveComsebaPage = () => {
  window.location.href =
    "https://store.steampowered.com/app/2575790/PROJECT__GENESIS/";
};

const moveComsebaYoutube = () => {
  window.location.href = "https://youtube.com/@RAMICSTUDIO?si=0SWCC7Cqn6gzcQqB";
};

const moveComsebaInstagram = () => {
  window.location.href = "https://www.instagram.com/ramic_studio/";
};
